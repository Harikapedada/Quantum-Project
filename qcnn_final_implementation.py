# -*- coding: utf-8 -*-
"""QCNN_Final_Implementation.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1rp4GbWySX104kt4CC6wQRmGRShwjEggO
"""
...
print(f"Training Recall: {history.history['recall_2'][-1] * 100:.2f}%")
print(f"Validation Recall: {history.history['val_recall_2'][-1] * 100:.2f}%")
